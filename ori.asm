...
I1 DQ 0x0000000020220003
; EN ESTOS DATOS SE SIMULA QUE EL REGISTRO RD ES EL NUMERO DOS ...0001 0000 0001 0001,
R0 DQ 0x0000000000000000
R1 DQ 0x0000000000000003
...
Add:
	...
	mov r8, [I1]; CARGA LA INSTRUCCION
        ...
        mov r10,[r11]; SE CARGA EL VALOR EN ESE REGISTRO
