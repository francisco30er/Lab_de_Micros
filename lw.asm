...
I1 DQ 0x000000008c220002; EN ESTOS DATOS SE SIMULA QUE EL REGISTRO RD ES EL NUMERO DOS ...0001 0000 0001 0001,
R0 DQ 0x0000000000000000
R1 DQ 0x0000000000000001
R2 DQ 0x0000000000000005
R3 DQ 0X0000000000000009
...
Add:
	...
	mov r8, [I1]; CARGA LA INSTRUCCION
        ...
        mov rax, 0x8; PARA MOVERSE EN MEMORIA DEBE SER DE OCHO EN OCHO
        mul r8; SE MULTIPLICA EL NUMERO DE REGISTRO POR OCHO, EL RESULTADO SE GUARDA EN RAX
        mov r12, R0; SE CARGA LA DIRECCION DEL REGISTRO BASE EN MEMORIA
        add r12, rax; SE LE SUMA EL OFFSET
        mov r14,[r12]; SE CARGA EL VALOR EN ESE REGISTRO
